...
namespace Assignment_1
{
    public class DecisionTree
    {
        ...
        public enum Features
        {
            ...
            TweetsPerDay, AverageLinks, AverageUniqueLinks, AverageUsername, AverageUniqueUsername, ChangeRate, ReTweet, /*Tag,*/ None
        }
        ...
        public Random Random_Variable { get; set; }

        public DecisionTree(ref List<TrainingData> trainingdata, int depth, Random rand)
        {
        ...
        public DecisionTree(bool isLeaf, ref List<TrainingData> trainingdata, int value, int depthRemaining, ref List<Features> featuresTaken, Random rand)
        {
            Random_Variable = rand;
            IsLeaf = isLeaf;
            Children = new List<DecisionTree>();
        ...
        private void SetInformationGain()
        {
            ...
            //Feature ReTweet values
            List<double> F17_Y_List = new List<double> { 0, 0, 0, 0, 0, 0 };
            List<double> F17_N_List = new List<double> { 0, 0, 0, 0, 0, 0 };
            List<double> F17_List_Total = new List<double> { 0, 0, 0, 0, 0, 0 };
            //Feature Tag values
            //List<double> F18_Y_List = new List<double> { 0, 0, 0, 0, 0, 0 };
            //List<double> F18_N_List = new List<double> { 0, 0, 0, 0, 0, 0 };
            //List<double> F18_List_Total = new List<double> { 0, 0, 0, 0, 0, 0 };
            #endregion
            ...
            {
                //Feature 1 counts
                if (item.screenNameLength == TrainingData.ScreenNameLength.Range1)
                {
                    if (item.Label == 1) { F1_Y_List[0]++; }
                    else { F1_N_List[0]++; }
                    F1_List_Total[0]++;
                }
                else if (item.screenNameLength == TrainingData.ScreenNameLength.Range2)
                {
                    if (item.Label == 1) { F1_Y_List[1]++; }
                    else { F1_N_List[1]++; }
                    F1_List_Total[1]++;
                }
                else if (item.screenNameLength == TrainingData.ScreenNameLength.Range3)
                {
                    if (item.Label == 1) { F1_Y_List[2]++; }
                    else { F1_N_List[2]++; }
                    F1_List_Total[2]++;
                }
                else if (item.screenNameLength == TrainingData.ScreenNameLength.Range4)
                {
                ...
                //Feature 2 
                if (item.descriptionLength == TrainingData.DescriptionLength.Range1)
                {
                    if (item.Label == 1) { F2_Y_List[0]++; }
                    else { F2_N_List[0]++; }
                    F2_List_Total[0]++;
                }
                else if (item.descriptionLength == TrainingData.DescriptionLength.Range2)
                {
                    if (item.Label == 1) { F2_Y_List[1]++; }
                    else { F2_N_List[1]++; }
                    F2_List_Total[1]++;
                }
                else if (item.descriptionLength == TrainingData.DescriptionLength.Range3)
                {
                    if (item.Label == 1) { F2_Y_List[2]++; }
                    else { F2_N_List[2]++; }
                    F2_List_Total[2]++;
                }
                else if (item.descriptionLength == TrainingData.DescriptionLength.Range4)
                {
                ...
                //Feature 3 
                if (item.Days == TrainingData.LongevityDays.Range1)
                {
                    if (item.Label == 1) { F3_Y_List[0]++; }
                    else { F3_N_List[0]++; }
                    F3_List_Total[0]++;
                }
                else if (item.Days == TrainingData.LongevityDays.Range2)
                {
                    if (item.Label == 1) { F3_Y_List[1]++; }
                    else { F3_N_List[1]++; }
                    F3_List_Total[1]++;
                }
                else if (item.Days == TrainingData.LongevityDays.Range3)
                {
                    if (item.Label == 1) { F3_Y_List[2]++; }
                    else { F3_N_List[2]++; }
                    F3_List_Total[2]++;
                }
                else if (item.Days == TrainingData.LongevityDays.Range4)
                {
                ...
                //Feature 4 
                if (item.Hours == TrainingData.LongevityHours.Range1)
                {
                    if (item.Label == 1) { F4_Y_List[0]++; }
                    else { F4_N_List[0]++; }
                    F4_List_Total[0]++;
                }
                else if (item.Hours == TrainingData.LongevityHours.Range2)
                {
                ...
                //Feature 17
                if (item.ReTweet == TrainingData.ReTweets.Range1)
                {
                    if (item.Label == 1) { F17_Y_List[0]++; }
                    else { F17_N_List[0]++; }
                    F17_List_Total[0]++;
                }
                else if (item.ReTweet == TrainingData.ReTweets.Range2)
                {
                    if (item.Label == 1) { F17_Y_List[1]++; }
                    else { F17_N_List[1]++; }
                    F17_List_Total[1]++;
                }
                else if (item.ReTweet == TrainingData.ReTweets.Range3)
                {
                    if (item.Label == 1) { F17_Y_List[2]++; }
                    else { F17_N_List[2]++; }
                    F17_List_Total[2]++;
                }
                else if (item.ReTweet == TrainingData.ReTweets.Range4)
                {
                    if (item.Label == 1) { F17_Y_List[3]++; }
                    else { F17_N_List[3]++; }
                    F17_List_Total[3]++;
                }
                else if (item.ReTweet == TrainingData.ReTweets.Range5)
                {
                    if (item.Label == 1) { F17_Y_List[4]++; }
                    else { F17_N_List[4]++; }
                    F17_List_Total[4]++;
                }
                else
                {
                    if (item.Label == 1) { F17_Y_List[5]++; }
                    else { F17_N_List[5]++; }
                    F17_List_Total[5]++;
                }

                //Feature 18
                //if (item.Tag == TrainingData.Tags.Range1)
                //{
                //    if (item.Label == 1) { F18_Y_List[0]++; }
                //    else { F18_N_List[0]++; }
                //    F18_List_Total[0]++;
                //}
                //else if (item.Tag == TrainingData.Tags.Range2)
                //{
                //    if (item.Label == 1) { F18_Y_List[1]++; }
                //    else { F18_N_List[1]++; }
                //    F18_List_Total[1]++;
                //}
                //else if (item.Tag == TrainingData.Tags.Range3)
                //{
                //    if (item.Label == 1) { F18_Y_List[2]++; }
                //    else { F18_N_List[2]++; }
                //    F18_List_Total[2]++;
                //}
                //else if (item.Tag == TrainingData.Tags.Range4)
                //{
                //    if (item.Label == 1) { F18_Y_List[3]++; }
                //    else { F18_N_List[3]++; }
                //    F18_List_Total[3]++;
                //}
                //else if (item.Tag == TrainingData.Tags.Range5)
                //{
                //    if (item.Label == 1) { F18_Y_List[4]++; }
                //    else { F18_N_List[4]++; }
                //    F18_List_Total[4]++;
                //}
                //else
                //{
                //    if (item.Label == 1) { F18_Y_List[5]++; }
                //    else { F18_N_List[5]++; }
                //    F18_List_Total[5]++;
                //}
            ...
            informationGain.ReTweet = CalculateInformationGain(F17_List_Total, F17_Y_List, F17_N_List);
            //informationGain.Tag = CalculateInformationGain(F18_List_Total, F18_Y_List, F18_N_List);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        private void DetermineFeature()
        {
            ...
            else if (list.Max() == list[16]) { Feature = Features.ReTweet; }
            //else if (list.Max() == list[17]) { Feature = Features.Tag; }
            ...
            if(list.All(x => x == 0))
            {
                ...
                else if (!FeaturesTaken.Contains(Features.ReTweet)) { Feature = Features.ReTweet; }
                //else if (!FeaturesTaken.Contains(Features.Tag)) { Feature = Features.Tag; }
                else { Feature = Features.None; }
            }
        }
        private void DetermineSubTrees()
        {
            ...
            List<List<TrainingData.ReTweets>> reTweet = new List<List<TrainingData.ReTweets>>();
            //List<List<TrainingData.Tags>> tag = new List<List<TrainingData.Tags>>();
            //char? LeftLeafValue = null;
            //List<TrainingData> LeftData;
            if (Feature == Features.ScreenNameLength)
            {
                Datas.Add(trainingData.Where(x => x.screenNameLength == TrainingData.ScreenNameLength.Range1).ToList());
                Datas.Add(trainingData.Where(x => x.screenNameLength == TrainingData.ScreenNameLength.Range2).ToList());
                Datas.Add(trainingData.Where(x => x.screenNameLength == TrainingData.ScreenNameLength.Range3).ToList());
                Datas.Add(trainingData.Where(x => x.screenNameLength == TrainingData.ScreenNameLength.Range4).ToList());
                Datas.Add(trainingData.Where(x => x.screenNameLength == TrainingData.ScreenNameLength.Range5).ToList());

            }
            else if (Feature == Features.DescriptionLength)
            {
                Datas.Add(trainingData.Where(x => x.descriptionLength == TrainingData.DescriptionLength.Range1).ToList());
                Datas.Add(trainingData.Where(x => x.descriptionLength == TrainingData.DescriptionLength.Range2).ToList());
                Datas.Add(trainingData.Where(x => x.descriptionLength == TrainingData.DescriptionLength.Range3).ToList());
                Datas.Add(trainingData.Where(x => x.descriptionLength == TrainingData.DescriptionLength.Range4).ToList());
                Datas.Add(trainingData.Where(x => x.descriptionLength == TrainingData.DescriptionLength.Range5).ToList());
            }
            else if (Feature == Features.Days)
            {
                Datas.Add(trainingData.Where(x => x.Days == TrainingData.LongevityDays.Range1).ToList());
                Datas.Add(trainingData.Where(x => x.Days == TrainingData.LongevityDays.Range2).ToList());
                Datas.Add(trainingData.Where(x => x.Days == TrainingData.LongevityDays.Range3).ToList());
                Datas.Add(trainingData.Where(x => x.Days == TrainingData.LongevityDays.Range4).ToList());
                Datas.Add(trainingData.Where(x => x.Days == TrainingData.LongevityDays.Range5).ToList());
            }
            else if (Feature == Features.Hours)
            {
                Datas.Add(trainingData.Where(x => x.Hours == TrainingData.LongevityHours.Range1).ToList());
                Datas.Add(trainingData.Where(x => x.Hours == TrainingData.LongevityHours.Range2).ToList());
                Datas.Add(trainingData.Where(x => x.Hours == TrainingData.LongevityHours.Range3).ToList());
            }
            ...
            else if(Feature == Features.ChangeRate) //change rate
            {
            ...
            else //if(Feature == Features.ReTweet)
            {
                Datas.Add(trainingData.Where(x => x.ReTweet == TrainingData.ReTweets.Range1).ToList());
                Datas.Add(trainingData.Where(x => x.ReTweet == TrainingData.ReTweets.Range2).ToList());
                Datas.Add(trainingData.Where(x => x.ReTweet == TrainingData.ReTweets.Range3).ToList());
                Datas.Add(trainingData.Where(x => x.ReTweet == TrainingData.ReTweets.Range4).ToList());
                Datas.Add(trainingData.Where(x => x.ReTweet == TrainingData.ReTweets.Range5).ToList());
                Datas.Add(trainingData.Where(x => x.ReTweet == TrainingData.ReTweets.Range6).ToList());
            }
            //else //if(Feature == Features.Tag)
            //{
            //    Datas.Add(trainingData.Where(x => x.Tag == TrainingData.Tags.Range1).ToList());
            //    Datas.Add(trainingData.Where(x => x.Tag == TrainingData.Tags.Range2).ToList());
            //    Datas.Add(trainingData.Where(x => x.Tag == TrainingData.Tags.Range3).ToList());
            //    Datas.Add(trainingData.Where(x => x.Tag == TrainingData.Tags.Range4).ToList());
            //    Datas.Add(trainingData.Where(x => x.Tag == TrainingData.Tags.Range5).ToList());
            //    Datas.Add(trainingData.Where(x => x.Tag == TrainingData.Tags.Range6).ToList());
            //}
            ...
            foreach (var item in Datas)
            {
                ...
                reTweet.Add((from h in item select h.ReTweet).Distinct().ToList());
                //tag.Add((from h in item select h.Tag).Distinct().ToList());
            }
            for (int i = 0; i < Datas.Count; i++)
            {
                if(screenNameLength[i].Count == 1 && descriptionLength[i].Count == 1 && Days[i].Count == 1 && Hours[i].Count == 1 && Minutes[i].Count == 1 &&
                    ...
                    && reTweet[i].Count == 1 /*&& tag[i].Count == 1*/)
                {
                    Is_Leaf[i] = true;
            ...
            else
            {
                ...
                if (DepthRemaining > 1)
                {
                    for (int i = 0; i < Datas.Count; i++)
                    {
                        ...
                        Children.Add(new DecisionTree(Is_Leaf[i], ref data, LeafValues[i], DepthRemaining - 1, ref featuresTakenHelper, Random_Variable));
                    }
                }
                else
                {
                    for (int i = 0; i < Datas.Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    LeafValues[i] = (Random_Variable.Next() % 2);
                                }
                            }
                            List<TrainingData> data = Datas[i];
                            Children.Add(new DecisionTree(true, ref data, LeafValues[i], DepthRemaining - 1, ref featuresTakenHelper, Random_Variable));
                        }
                    }
                }
            }            
        ...
        private List<int> DetermineSubError(TrainingData item)
        {
            ...
            {   
                if (Feature == Features.ScreenNameLength)
                {
                    if (item.screenNameLength == TrainingData.ScreenNameLength.Range1) { return Children[0].DetermineSubError(item); }
                    else if (item.screenNameLength == TrainingData.ScreenNameLength.Range2) { return Children[1].DetermineSubError(item); }
                    else if (item.screenNameLength == TrainingData.ScreenNameLength.Range3) { return Children[2].DetermineSubError(item); }
                    else if (item.screenNameLength == TrainingData.ScreenNameLength.Range4) { return Children[3].DetermineSubError(item); }
                    else { return Children[4].DetermineSubError(item); }
                }
                else if (Feature == Features.DescriptionLength)
                {
                    if (item.descriptionLength == TrainingData.DescriptionLength.Range1) { return Children[0].DetermineSubError(item); }
                    else if (item.descriptionLength == TrainingData.DescriptionLength.Range2) { return Children[1].DetermineSubError(item); }
                    else if (item.descriptionLength == TrainingData.DescriptionLength.Range3) { return Children[2].DetermineSubError(item); }
                    else if (item.descriptionLength == TrainingData.DescriptionLength.Range4) { return Children[3].DetermineSubError(item); }
                    else { return Children[4].DetermineSubError(item); }
                }
                else if (Feature == Features.Days)
                {
                    if (item.Days == TrainingData.LongevityDays.Range1) { return Children[0].DetermineSubError(item); }
                    else if (item.Days == TrainingData.LongevityDays.Range2) { return Children[1].DetermineSubError(item); }
                    else if (item.Days == TrainingData.LongevityDays.Range3) { return Children[2].DetermineSubError(item); }
                    else if (item.Days == TrainingData.LongevityDays.Range4) { return Children[3].DetermineSubError(item); }
                    else { return Children[4].DetermineSubError(item); }
                }
                else if (Feature == Features.Hours)
                {
                    if (item.Hours == TrainingData.LongevityHours.Range1) { return Children[0].DetermineSubError(item); }
                    else if (item.Hours == TrainingData.LongevityHours.Range2) { return Children[1].DetermineSubError(item); }
                ...
                else if (Feature == Features.ChangeRate)
                {
                ...
                {
                    if (item.ReTweet == TrainingData.ReTweets.Range1) { return Children[0].DetermineSubError(item); }
                    else if (item.ReTweet == TrainingData.ReTweets.Range2) { return Children[1].DetermineSubError(item); }
                    else if (item.ReTweet == TrainingData.ReTweets.Range3) { return Children[2].DetermineSubError(item); }
                    else if (item.ReTweet == TrainingData.ReTweets.Range4) { return Children[3].DetermineSubError(item); }
                    else if (item.ReTweet == TrainingData.ReTweets.Range5) { return Children[4].DetermineSubError(item); }
                    else { return Children[5].DetermineSubError(item); }
                }
                //else //(Feature == Features.Tag)
                //{
                //    if (item.Tag == TrainingData.Tags.Range1) { return Children[0].DetermineSubError(item); }
                //    else if (item.Tag == TrainingData.Tags.Range2) { return Children[1].DetermineSubError(item); }
                //    else if (item.Tag == TrainingData.Tags.Range3) { return Children[2].DetermineSubError(item); }
                //    else if (item.Tag == TrainingData.Tags.Range4) { return Children[3].DetermineSubError(item); }
                //    else if (item.Tag == TrainingData.Tags.Range5) { return Children[4].DetermineSubError(item); }
                //    else { return Children[5].DetermineSubError(item); }
                //}
            }
        }

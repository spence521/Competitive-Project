...
namespace Assignment_1
{
    public class InformationGain
    {
        ...
        public InformationGain(double screenNameLen, double desLength, double days, double hours, double minutes, double seconds,
            ...
            double aveUniqueUsername, double changeRt, double reTweet)
        {
        ...
        public List<double> ToList()
        {
            return new List<double>
            {
                ...
                AverageUniqueLinks, AverageUsername, AverageUniqueUsername, ChangeRate, ReTweet
            };
        }

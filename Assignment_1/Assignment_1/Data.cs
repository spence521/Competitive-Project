...
namespace Assignment_1
{
    public class Data
    {
       ...
       // public StreamReader reader_2 { get; set; }
        ...
        public void SetData(StreamReader reader, StreamReader reader_2)
        {
        ...
        public void SetTrainingData()
        {
            foreach (var item in data_1)
            {
                Training_Data.Add(new TrainingData(ScreenNameLength(item.Vector[0]), DescriptionLength(item.Vector[1]), Days(item.Vector[2]), Hours(item.Vector[3]), 
                    ...
                    Tweets(item.Vector[10]), AverageLinks(item.Vector[11]), AverageLinks(item.Vector[12]), AverageUsername(item.Vector[13]), 
        ...
        {
            if(value <= 3) { return TrainingData.ScreenNameLength.Range0_3; }
            else if (3 < value && value <= 6) { return TrainingData.ScreenNameLength.Range4_6; }
            else if (6 < value && value <= 9) { return TrainingData.ScreenNameLength.Range7_9; }
            else if (9 < value && value <= 12) { return TrainingData.ScreenNameLength.Range10_12; }
            else { return TrainingData.ScreenNameLength.RangeGT_12; }
        }
        public TrainingData.DescriptionLength DescriptionLength(double value)
        {
            if (value <= 33) { return TrainingData.DescriptionLength.Range0_33; }
            else if (33 < value && value <= 66) { return TrainingData.DescriptionLength.Range34_66; }
            else if (66 < value && value <= 99) { return TrainingData.DescriptionLength.Range67_99; }
            else if (99 < value && value <= 132) { return TrainingData.DescriptionLength.Range100_132; }
        ...
        {
            if (value <= 8) { return TrainingData.LongevityHours.Range0_8; }
            else if (8 < value && value <= 16) { return TrainingData.LongevityHours.Range9_16; }
        ...
        public TrainingData.Follow Follow(double value)
        {
            if (value <= 100) { return TrainingData.Follow.Range0_100; }
            else if (100 < value && value <= 400) { return TrainingData.Follow.Range101_400; }
            else if (400 < value && value <= 1400) { return TrainingData.Follow.Range401_1400; }
            else if (1400 < value && value <= 3000) { return TrainingData.Follow.Range1401_3000; }
            else if (3000 < value && value <= 10000) { return TrainingData.Follow.Range3001_10000; }
            else { return TrainingData.Follow.RangeGT_10000; }
        }
        public TrainingData.Ratio Ratio(double value)
        {
            if (value <= 1) { return TrainingData.Ratio.Range0_1; }
            else if (1 < value && value <= 3) { return TrainingData.Ratio.Range1_3; }
            else if (3 < value && value <= 8) { return TrainingData.Ratio.Range3_8; }
            else { return TrainingData.Ratio.RangeGT_8; }
        }
        public TrainingData.Tweets Tweets(double value)
        {
            if (value <= 66) { return TrainingData.Tweets.Range0_66; }
            else if (66 < value && value <= 132) { return TrainingData.Tweets.Range67_132; }
            else { return TrainingData.Tweets.RangeGT_132; }
        }
        public TrainingData.AverageLinks AverageLinks(double value)
        {
        ...
        public TrainingData.AverageUsername AverageUsername(double value)
        {
        ...
        public TrainingData.ChangeRate ChangeRate(double value)
        {
            if (value <= 2) { return TrainingData.ChangeRate.Range0_5; }
            else if (2 < value && value <= 4) { return TrainingData.ChangeRate.Range5_50; }
